...
const IMC = () => {
    ...
    const CalcIMC = () => {
        ...
        if (calcIMC < 18.5) {
            ...
            msg = 'Sobrepeso';
        } else if (calcIMC >= 30 && calcIMC < 50) {
            msg = 'Obesidade';
        } else {
            msg = 'Verifique se os dados estão corretos';
        }
        setMensagem(msg); 
    };
    ...
    return (
        <div style={{ textAlign: 'center', margin: '20px' }}>
            ...
            <img 
                src="https://caminhosalutar.com.br/wp-content/uploads/2023/04/Purple-Plaid-Modern-Problem-and-Solution-Table-Graph-1.png.webp" 
                alt="Tabela de IMC"
